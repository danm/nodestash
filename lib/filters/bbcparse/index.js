...
module.exports = function(line, preference, _this) {
    ...
    // if the referral is form a news home page, we want to find the what edition the page was.
    if ((line.for_nation !== undefined && line.rp && line.rp.type === 'bbc' && line.rp.name === 'news' && line.rp.page === 0) || 
        (line.for_nation !== undefined && line.rp && line.rp.type === 'bbc' && line.rp.name === 'news' && line.rp.page === 'home')) {
        if (line.for_nation) {
            line.edition = editions(line.for_nation); 
        }
    }
