...
module.exports = (line) => {
      ...
      if (line.bbc.topics) elastic.bbc_topics = elastic.bbc_topics;
      ...
      fs.appendFileSync('./tmp/elastic.ndjson', meta + '\n');
      fs.appendFileSync('./tmp/elastic.ndjson', JSON.stringify(elastic) + '\n');
