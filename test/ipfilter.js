...
const ipfilter = require('../lib/filters/ipfilter');
...
describe("Parse IP", function() {
	...
	it('should return true because the ip is blocked', function() {
		//arrange
		let line = new sampleObj();
		line.ip = '212.48.79.10';
		//act
		let res = ipfilter(line, template.ipblock);
		//assert
		expect(res).to.be.true;
	});

	it('should return false because the ip isnt blocked', function() {
		//arrange
		let line = new sampleObj();
		//act
		let res = ipfilter(line, template.ipblock);
